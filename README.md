...
- **多语言扩展**：`zh/` 89 篇、`en/ es/ fr/` 各 15 篇已上线，`ar/` 规划中——新增语言即增加对应文件夹
...
- **应用文档系列**：另含 89 篇「价值守恒 × 经典/史著/思想」四语科普页（zh 89、en/es/fr 各 15）（见上节），按 `zh/`、`en/`、`es/`、`fr/` 分目录存放，每篇含左侧导航、滚动高亮、GEO 优化与广告法合规内容
...
├── library-society.html    # 分类导航页：国家 · 经济社会（S，52 篇）
